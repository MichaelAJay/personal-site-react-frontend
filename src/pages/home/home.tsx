      ...
      <Hero>
        <div>
          <img
            ...
            src={`${process.env.PUBLIC_URL}/home-hero_mid.jpg`}
            alt="Surreal mountains scene"
          />
        </div>
        <Row className="home-proficiencies-bar" justify={'space-around'}>
        ...
        <HomeSkillSection
          ...
          img={{
            isLeft: true,
            alt: 'Alt lifecycle card section image',
            src: '/project-lifecycle-expertise-section-image.png',
          }}
        ...
        <HomeSkillSection
          ...
          img={{
            isLeft: false,
            alt: 'Alt craftsmanship card section image',
            src: '/code-craftsmanship-section-image.png',
          }}
        ...
        <HomeSkillSection
          ...
          img={{
            isLeft: true,
            alt: 'Alt Dedication section image',
            src: '/dedication-section-image.png',
          }}
        ...
        <HomeSkillSection
          ...
          img={{
            isLeft: false,
            alt: 'Alt Continuous Learner card section image',
            src: '/continuous-learner-section-image.png',
          }}
