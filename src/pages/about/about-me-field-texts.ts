...
export const technologiesOBJECTS: Array<IProgressBadgeProps & { tabs: Set<TabNames> }> = [
    ...
    { title: 'External Integrations', level: skillLevel.Advanced.name, dashPercent: 80, description: 'REST deployments', tabs: new Set<TabNames>(['Frontend Development', 'Backend Development']) },
    { title: 'REST', level: skillLevel.Advanced.name, dashPercent: 80, description: 'REST deployments', tabs: new Set<TabNames>(['Frontend Development', 'Backend Development']) },
    { title: 'Accessibility', level: skillLevel.Beginner.name, dashPercent: 15, tabs: new Set<TabNames>(['Frontend Development']) },
    { title: 'GraphQL (Consumption)', level: skillLevel.Intermediate.name, dashPercent: 50, description: 'REST deployments', tabs: new Set<TabNames>(['Frontend Development', 'Backend Development']) },
    { title: 'RPC (Consumption)', level: skillLevel.Intermediate.name, dashPercent: 50, description: 'REST deployments', tabs: new Set<TabNames>(['Frontend Development', 'Backend Development']) },
    { title: 'API Creation', level: skillLevel.Advanced.name, dashPercent: 80, description: 'REST deployments', tabs: new Set<TabNames>(['Backend Development']) },
    ...
    { title: 'Express', level: skillLevel.Advanced.name, dashPercent: 50,  tabs: new Set<TabNames>(['Backend Development']) },
    { title: 'Fastify', level: skillLevel.Advanced.name, dashPercent: 40, tabs: new Set<TabNames>(['Backend Development']) },
    { title: 'HAPI', level: skillLevel.Advanced.name, dashPercent: 50, tabs: new Set<TabNames>(['Backend Development']) },
    { title: 'Request Validation', level: skillLevel.Advanced.name, dashPercent: 70, tabs: new Set<TabNames>(['Backend Development']) },
    ...
    { title: 'Ant Design', level: skillLevel.Intermediate.name, dashPercent: 55, tabs: new Set<TabNames>(['Frontend Development']) },
    ...
    { title: 'Responsive Web Design', level: skillLevel.Beginner.name, dashPercent: 20, tabs: new Set<TabNames>(['Frontend Development']) },
    { title: 'Tailwind CSS', level: skillLevel.Beginner.name, dashPercent: 15, tabs: new Set<TabNames>(['Frontend Development']) },
    { title: 'State Management', level: skillLevel.Beginner.name, dashPercent: 10, tabs: new Set<TabNames>(['Frontend Development']) },
    { title: 'Understanding of DOM', level: skillLevel.Beginner.name, dashPercent: 5, tabs: new Set<TabNames>(['Frontend Development']) },
    ...
    { title: 'Sentry (Performance Monitoring and Error Tracking', level: skillLevel.Novice.name, dashPercent: 45, tabs: new Set<TabNames>(['Frontend Development', 'Backend Development']) },
